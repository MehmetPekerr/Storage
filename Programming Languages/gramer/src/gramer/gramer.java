...
public class gramer {
    public static void main(String[] args) {
        ...
        // Cümleyi boşluklardan ayırarak kelimelere böl
        String[] kelimeler = cumle.split("\\s+");

        // Eğer cümle 3 kelime içeriyorsa ve her kelime de ilgili kümede varsa, cümle geçerli kabul edilir
    ...
    // Verilen elemanın, verilen küme içinde olup olmadığını kontrol eden metod
